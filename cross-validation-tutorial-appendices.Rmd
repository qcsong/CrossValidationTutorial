...
In this example, we treat the 70,798 observations as the population and fit a regression model to obtain the population estimates (see R code below). As a result, in the population, $R2_{population} = .28$, and $MSE_{population} = 0.45$.
...
mod <- lm(mach ~ age + as.factor(gender) + as.factor(education) +
                 as.factor(engnat) + as.factor(married) + 
                 O + C + E + A + N,
          data=data)
...
mod_cal <- lm(mach ~ age + as.factor(gender) + as.factor(education) +
                     as.factor(engnat) + as.factor(married) + 
                     O + C + E + A + N,
              data=sample_cal)
...
kfold_cv <- train(mach ~ age + as.factor(gender) + as.factor(education) +
                         as.factor(engnat) + as.factor(married) + 
                         O + C + E + A + N,
...
mc_cv <- train(mach ~ age + as.factor(gender) + as.factor(education) +
                      as.factor(engnat) + as.factor(married) + 
                      O + C + E + A + N,
