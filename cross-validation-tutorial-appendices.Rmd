...
Notice that, when the population effect size is .04, across 1,000 trials, the average $R_{validation}^2 = .03$ is less than half the average $R_{calibration}^2 = .08$ (63% reduction versus 15% reduction in Observation 2), and the average $MSE_{validation} = 10.48$ is larger than the average $MSE_{calibration} = 9.10$ (1.39 increase versus 0.17 increase in Observation 2). This suggests that, when the population effect size is small, the model tend to generalize less well in a new sample. 
